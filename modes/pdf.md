...
- **Section headers**: Space Grotesk 13px, uppercase, letter-spacing 0.05em, cyan primary colour
...
Use the template at `cv-template.html`. Replace `{{...}}` placeholders with personalised content:
