...
Execute exactly as per the `evaluate` mode (read `modes/evaluate.md` for all blocks A-F).
...
**Stance: "I'm choosing you."** — the candidate has options and is choosing this company for specific reasons.
